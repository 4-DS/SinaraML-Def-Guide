...
Combining the backend and model files, we combine  development artifacts, which have a significantly different life cycle, development process, different skills needed for development, often even different programming languages.
